...
public class Accuracy {
    ...
    public int evaluateScore(double height, int targetHeight, boolean triggered) {
    ...
    public static boolean specialNoteInRange(double height, int targetHeight) {
        double distance = Math.abs(height - targetHeight);
        return distance <= GOOD_RADIUS;
    }

    public static boolean outOfScreen(double height) {
        return height >= (Window.getHeight());
    }
